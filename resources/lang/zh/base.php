...
return [
    ...
    'errors' => [
        ...
        '403' => [
            'header' => '禁止訪問',
            'desc' => '您沒有訪問此服務器上的資源的權限。',
        ],
        '404' => [
            'header' => '文件未找到',
            'desc' => '我們無法在此服務器上找到所請求的資源。',
        ],
        'installing' => [
            'header' => '服務器安裝中',
            'desc' => '請求的服務器正在完成安裝進程。請幾分鐘後再來查看，您將在此過程完成後收到電子郵件提醒。',
        ],
        'suspended' => [
            'header' => '服務器已停用',
            'desc' => '此服務器已停用且無法訪問。',
    ...
    'security' => [
        'session_mgmt_disabled' => '您的托管商未啟用此界面來管理賬戶會話。',
        'header' => '賬戶安全',
        ...
        'disable_2fa' => '關閉兩步驗證',
        '2fa_enabled' => '已為此賬戶啟用兩步驗證，您將需要驗證以登錄至此賬戶。若您想關閉兩步驗證，您只需在下方輸入密鑰並提交即可。',
        '2fa_disabled' => '已關閉兩步驗證！您應啟用此功能來作為此賬戶的附加防護手段。',
        'enable_2fa' => '啟用兩步驗證',
        '2fa_qr' => '在您的設備上配置兩步驗證',
        '2fa_checkpoint_help' => '在您的手機上使用兩步驗證應用程序掃描左側的二維碼或直接輸入下方的代碼。錄入後，請在下方輸入應用程序生成的密碼。',
        '2fa_disable_error' => '提供的兩步驗證密鑰無效。未關閉此賬戶的兩步驗證。兩步驗證密碼錯誤. 關閉兩步驗證失敗.',
    ],
];
