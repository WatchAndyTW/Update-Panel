...
return [
    ...
    'nest' => [
        'delete_has_servers' => '無法刪除附著到活躍伺服器上的管理模塊。',
        'egg' => [
            'delete_has_servers' => '無法刪除附著到活躍伺服器上的管理模塊。',
    ...
    'packs' => [
        'delete_has_servers' => '無法刪除依附到活躍伺服器的整合包。',
        'update_has_servers' => '無法在有伺服器依附至整合包時修改關聯選項編號。',
        'invalid_upload' => '所提供的文件格式無效。',
        'invalid_mime' => '提供的文件不符合所需文件類型 :type',
        'unreadable' => '伺服器無法打開所提供的歸檔文件。',
        'zip_extraction' => '提取歸檔文件至伺服器時發生錯誤。',
        'invalid_archive_exception' => '整合包歸檔文件的根目錄似乎缺少 archive.tar.gz 或 import.json。',
    ],
    'subusers' => [
        'editing_self' => '您無法作為子用戶編輯您自己的子用戶賬號。',
        'user_is_owner' => '您無法作為子用戶來添加為此伺服器的服主。',
        'subuser_exists' => '使用該電子郵件地址的用戶已被分配為此伺服器的子用戶。',
    ],
    'databases' => [
        'delete_has_databases' => '無法刪除關聯至活躍數據庫的數據庫伺服器。',
    ],
    'tasks' => [
    ...
    'api' => [
        'resource_not_found' => '伺服器上不存在所請求的資源。',
    ],
];
