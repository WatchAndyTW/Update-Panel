        ...
        <div class="wrapper">
            <header class="main-header">
                <a href="{{ route('index') }}" class="logo">
                    <span class="logo-lg"><img src="/favicons/android-chrome-192x192.png"></span>
            ...
            <footer class="main-footer">
                ...
                Copyright &copy; 2015 - {{ date('Y') }} <a href="https://pterodactyl.io/">Pterodactyl Software</a>. Theme by HookDonn_ && WatchAndyTW.
            </footer>
            @if(isset($sidebarServerList))
