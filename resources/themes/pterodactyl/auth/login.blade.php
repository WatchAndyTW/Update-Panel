		...
		<div class="container-login100">
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" id="loginForm" action="{{ route('auth.login') }}" method="post">
					...
					<div class="container-login100-form-btn">
						{!! csrf_field() !!}
						<button type="submit" class="login100-form-btn btn btn-primary btn-block g-recaptcha pterodactyl-login-button--main" href="https://discord.gg/X8EcjFh"> @endif>沒有帳號? 加入我們的DC申請吧!</button>
					</div>
