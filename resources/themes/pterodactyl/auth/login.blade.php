			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" id="loginForm" action="{{ route('auth.login') }}" method="post">
					...
					<div class="container-login100-form-btn">
						{!! csrf_field() !!}
						<button type="submit" class="login100-form-btn btn btn-primary btn-block g-recaptcha pterodactyl-login-button--main" data-callback='onSubmit' @endif>@lang('auth.sign_in')</button>
					</div>
