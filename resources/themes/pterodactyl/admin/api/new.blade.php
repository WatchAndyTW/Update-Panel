...
@section('content-header')
    <h1>Application API<small>創建一個開發人員API金鑰</small></h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.index') }}">Admin</a></li>
        <li><a href="{{ route('admin.api.index') }}">開發人員API</a></li>
        <li class="active">新增收藏</li>
    </ol>
@endsection
                ...
                <div class="box box-primary">
                    <div class="box-body">
                        <div class="form-group">
                            <label class="control-label" for="memoField">說明 <span class="field-required"></span></label>
                            <input id="memoField" type="text" name="memo" class="form-control">
                        </div>
                        <p class="text-muted">一旦您創建了一個開發人員API金鑰，您將無法更改設定，請確認設定完成後再創建，謝謝</p>
                    </div>
