    ...
    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3">
        <div class="card card-stats">
            <div class="card-header card-header-info card-header-icon">
                ...
                <p class="card-category"><b>Allocated Disk Space</b></p>
    ...
    <div class="col-xs-12">
        <div class="box">
            ...
            <div class="box-footer text-center">
                ...
                @can('power-restart', $server)<button class="btn btn-primary disabled" data-attr="power" data-action="restart"><i class="fa fa-refresh"></i> Restart</button>@endcan
...
@section('footer-scripts')
    ...
    {!! Theme::js('/pure_colors_graphics.php') !!}
