    ...
    <div class="box-tools">
        <a href="/server/{{ $server->uuidShort }}/files/add/@if($directory['header'] !== '')?dir={{ $directory['header'] }}@endif">
            <button class="btn btn-success btn-sm btn-icon">
                New File <i class="fa fa-fw fa-file"></i>
            </button>
        </a>
        <button class="btn btn-sm btn-success btn-icon" data-action="add-folder">
            New Folder <i class="fa fa-fw fa-folder-open"></i>
        </button>
        ...
        <div class="btn-group hidden-xs">
            ...
            <ul class="dropdown-menu dropdown-massactions">
                <li><a href="#" id="selective-deletion" data-action="selective-deletion">@lang('server.files.delete') <i class="fa fa-fw fa-trash"></i></a></li>
            </ul>
        </div>
    </div>
</div>
        ...
        <thead>
            <tr>
                <th class="middle min-size">
                    <input type="checkbox" class="select-all-files hidden-xs" data-action="selectAll"><i class="fa fa-sync muted muted-hover use-pointer" data-action="reload-files" style="font-size:14px;margin-left: 5.5px;"></i>
                </th>
        ...
        <tbody id="append_files_to">
            @if (isset($directory['first']) && $directory['first'] === true)
                <tr data-type="disabled">
                    <td class="middle min-size"><i class="fa fa-folder" style="margin-left: 5.5px;"></i></td>
            ...
            @foreach ($folders as $folder)
                <tr data-type="folder">
                    <td class="middle min-size" data-identifier="type">
                        <input type="checkbox" class="select-folder hidden-xs" data-action="addSelection"><i class="fa fa-folder" style="margin-left: 5.5px;"></i>
                    </td>
                ...
                <tr data-type="file" data-mime="{{ $file['mime'] }}">
                    <td class="middle min-size" data-identifier="type"><input type="checkbox" class="select-file hidden-xs" data-action="addSelection">
                        ...
                        @if(in_array($file['mime'], [
                            ...
                            <i class="fa fa-file-archive" style="margin-left: 5.5px;"></i>
                        @elseif(in_array($file['mime'], [
                            ...
                            <i class="fa fa-file-code" style="margin-left: 5.5px;"></i>
                        @elseif(starts_with($file['mime'], 'image'))
                            <i class="fa fa-file-image" style="margin-left: 5.5px;"></i>
                        @elseif(starts_with($file['mime'], 'video'))
                            <i class="fa fa-file-video" style="margin-left: 5.5px;"></i>
                        @elseif(starts_with($file['mime'], 'video'))
                            <i class="fa fa-file-audio" style="margin-left: 5.5px;"></i>
                        @elseif(starts_with($file['mime'], 'application/vnd.ms-powerpoint'))
                            <i class="fa fa-file-powerpoint" style="margin-left: 5.5px;"></i>
                        @elseif(in_array($file['mime'], [
                            'application/vnd.openxmlformats-officedocument.wordprocessingml.document',
                            'application/vnd.openxmlformats-officedocument.wordprocessingml.template',
                            'application/msword'
                        ]) || starts_with($file['mime'], 'application/vnd.ms-word'))
                            <i class="fa fa-file-word" style="margin-left: 5.5px;"></i>
                        @elseif(in_array($file['mime'], [
                            'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',
                            'application/vnd.openxmlformats-officedocument.spreadsheetml.template',
                        ]) || starts_with($file['mime'], 'application/vnd.ms-excel'))
                            <i class="fa fa-file-excel" style="margin-left: 5.5px;"></i>
                        @elseif($file['mime'] === 'application/pdf')
                            <i class="fa fa-file-pdf" style="margin-left: 5.5px;"></i>
                        @else
                            <i class="fa fa-file-alt" style="margin-left: 5.5px;"></i>
                        @endif
                    </td>
