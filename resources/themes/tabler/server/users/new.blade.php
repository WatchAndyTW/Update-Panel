            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="btn-group pull-left">
                        <a id="selectAllCheckboxes" class="btn btn-sm btn-outline-light">@lang('strings.select_all')</a>
                        <a id="unselectAllCheckboxes" class="btn btn-sm btn-outline-light">@lang('strings.select_none')</a>
                    </div>
