    ...
    <div class="col-xs-12">
        <div class="box">
            ...
            <div class="box-footer text-center">
				<button class="btn btn-info" href="{{ route('server.console', $server->uuidShort) }}" id="console-popout"><i class="fas fa-external-link-alt"></i></button>
                @can('power-start', $server)<button class="btn btn-success disabled" data-attr="power" data-action="start">Start <i class="fas fa-play-circle"></i></button>@endcan
                @can('power-restart', $server)<button class="btn btn-primary disabled" data-attr="power" data-action="restart">Restart <i class="fas fa-sync"></i></button>@endcan
                @can('power-stop', $server)<button class="btn btn-danger disabled" data-attr="power" data-action="stop">Stop <i class="fas fa-stop-circle"></i></button>@endcan
                @can('power-kill', $server)<button class="btn btn-danger disabled" data-attr="power" data-action="kill">Kill <i class="fas fa-times-circle"></i></button>@endcan
            </div>
        </div>
    </div>
</div>
